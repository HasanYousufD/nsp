              ...
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <input type="hidden" name="function" value="register">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4c" class="form-control" name="psw" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="password" id="form3Example4cd" class="form-control" name="psw-repeat" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <?php foreach($data as $row){?>
                      ...
                      <label class="form-label" for="form3Example4cd">Select Department</label>
                    </div>
                  </div>
