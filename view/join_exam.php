        ...
        <div class="mt-3 mx-auto w-50">
          ...
          <div class="bg-light m-5 p-3">
            ...
            <?php
                ...
                //getting question id
                $sql="select id from `answer` where enrollment_id='".$_GET["enrollment_id"]."' and question_id='".$row["id"]."'";
                ...
                <form 
                    action="index.php"  
                    method="post">
                    <input type="hidden" name="function" value="insert_mcq_answer">
                    ...
                    <input type="hidden" name="correct_answer" value="<?php echo $mcq_question[0]["answer"];?>">
                    <input type="hidden" name="mark" value="<?php echo $row['mark'];?>">

                    <div class="mb-3">            
                    

                      <label for="exampleInputEmail1" class="form-label">Which One is correct?</label>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="answer" id="flexRadioDefault1" value="a">
                        <label class="form-check-label" for="flexRadioDefault1">
                        a
                ...
                <a href="<?php echo "assets/pdf/".$written_question[0]['file']; ?>"><button type="button" class="btn btn-secondary">Download</button></a>
                      ...
                      method="post"
                      enctype="multipart/form-data">
                      <input type="hidden" name="function" value="insert_written_answer">
                      <input type="hidden" name="exam_id" value="<?php echo $exam_id;?>">
                      <input type="hidden" name="question_id" value="<?php echo $row["id"];?>">
                      <input type="hidden" name="enrollment_id" value="<?php echo $_GET["enrollment_id"];?>">
                      ...
                      <div class="mb-3">            
                        ...
                        <label for="exampleInputEmail1" class="form-label">Answer:</label>
                        <textarea  class="form-control" id="exampleInputEmail1"   name="answer"></textarea>
                      </div>
